...
// CHANGING THE CODE IN THIS FILE CAN RESULT IN CHANGING THE OUTPUT OF STAFF
// CODE, MEANING THAT THE REFERENCE TESTS MAY NOT BE ACCURATE, PERHAPS IN SUBTLE
// WAYS. YOU MAY GET WEIRD FLOATING-POINT ERROR WHEN STAFF TESTS OCCUR.
// OPTIMIZING THESE SEPARATELY IS A SAFER APPROACH, IF YOU'D LIKE.
...
/**
 * @brief Copy the first nbytes of src into a new, heap-allocated array, and
 * return the new array. Returns NULL if allocation fails.
 *
